...
public class WakeUpTree {
  ...
  /**
   * Diese Methode fügt der Wake-Up-Tree ein Pfad hinzu.
   * Für jedes neues Child wird der Parent gefunden,
   * und due Distanz vom Root bis zu diesem Child berechnet.
  ...
  /**
   * Makespan: ist die Länge des längsten Pfades im Aufwachbaum. d.h. Es ist die maximale
   * Zeit, die benötigt wird, um alle Roboter im System zu aktivieren.
   * Die Kosten für jeden Pfad werden in DER Variable "totalDistanceFromRoot" gespeichert.
   * @return den makespan
   */
  ...
  static final class Child {
    ...
    private transient Child parent;
